...
class Simulation:
	...
	def run_election(self):
		...
		swing_percent_other_voting = swing_percent_other_voting * (self.american_electorate.swing/100)
...
class SwingGroup:
	...
	def printGroup(self):
		return [self.republican_leaning, self.democrat_leaning, self.undecided, self.swing_percentage]
